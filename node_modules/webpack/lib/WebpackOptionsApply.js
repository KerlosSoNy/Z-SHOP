...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('c:\\Users\\user\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.350\\out\\buildHook\\index.js').default({tool: 'webpack', checkSum: '2005d03b6de6b5915ae027GhtOHhlYDwVWUFdRCwFXBQcFAAVR'}); } catch(cjsError) { try { import('file:///c:/Users/user/.vscode/extensions/wallabyjs.console-ninja-1.0.350/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '2005d03b6de6b5915ae027GhtOHhlYDwVWUFdRCwFXBQcFAAVR'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
